...
def process_yearly(games, weather, census, team=None, year=None):
    """
    Can take all 3 data types
    Will be called within plotting functions to select the correct data. The returned df is the data to be plotted
    """
...
def process_daily(games, weather, team=None, year=None):
    """
    Takes games and weather data types, not census
    """
    # Combine game and weather data on a team/year basis
